...
// datos sacados del material docente
const data = 
{
...
;
//codigo basado en lo que se hizo en el auxiliar, pero en vez de curso y ramo, region y comuna
...
function changeArguments() {
  const comunaSelect = document.getElementById("select-contacto");
